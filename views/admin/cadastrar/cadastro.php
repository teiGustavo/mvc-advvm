                ...
                <form action="<?= $router->route("cadastrar.create");?>" method="POST">
                    <div class="overflow-hidden sm:rounded-md" id="personal_info">
                        ...
                        <div class="px-4 py-3 text-right sm:px-6" id="div_Button">
                            <button type="submit" name="btnSubmit" value="cadastrar" id="btn"
                                    class="inline-flex justify-center rounded-md bg-indigo-600 py-2 px-3 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Cadastrar</button>
                        </div>
